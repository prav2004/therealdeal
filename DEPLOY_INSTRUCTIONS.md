...
gcloud run deploy pickr-backend --image us-central1-docker.pkg.dev/pickr-d4d9b/pickr-repo/pickr-backend --platform managed --region us-central1 --allow-unauthenticated
```
