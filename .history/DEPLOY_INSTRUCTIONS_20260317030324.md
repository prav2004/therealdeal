...
gcloud run deploy pickr-backend --image us-central1-docker.pkg.dev/pickr-d4d9b/pickr-repo/pickr-backend --platform managed --region us-central1 --allow-unauthenticated --set-env-vars APISPORTS_KEY=0254dcc218e487f9523bf40edda8640f,SPORTSDATAIO_KEY=YOUR_SPORTSDATAIO_KEY,ODDS_API_KEY=YOUR_ODDS_API_KEY
```
