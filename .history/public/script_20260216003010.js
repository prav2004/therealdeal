(function () {
  ...
  const AVATAR_PRESETS = {
    'avatar-1': { skin: '#f8d7c1', hair: '#5a2a18', lip: '#c2410c', hairStyle: 'short', jersey: '#0ea5e9', accent: '#082f49', badge: 'QB' },
    'avatar-2': { skin: '#f2c8a0', hair: '#1f2937', lip: '#b45309', hairStyle: 'fade', jersey: '#22c55e', accent: '#064e3b', badge: 'RB' },
    'avatar-3': { skin: '#f4d6b0', hair: '#0f172a', lip: '#c2410c', hairStyle: 'spike', jersey: '#f97316', accent: '#7c2d12', badge: '3PT' },
    'avatar-4': { skin: '#efc9a2', hair: '#334155', lip: '#c2410c', hairStyle: 'cap', jersey: '#a855f7', accent: '#4c1d95', badge: 'PG' },
    'avatar-5': { skin: '#f5d3c8', hair: '#7f1d1d', lip: '#be185d', hairStyle: 'long', jersey: '#ef4444', accent: '#7f1d1d', badge: 'ST' },
    'avatar-6': { skin: '#f2d1b3', hair: '#312e81', lip: '#be185d', hairStyle: 'bob', jersey: '#facc15', accent: '#713f12', badge: 'GK' }
  };
  ...
  function renderAvatar(el, avatarId) {
    ...
    el.innerHTML = '<span class="hair"></span><span class="eye left"></span><span class="eye right"></span><span class="mouth"></span><span class="jersey"></span><span class="badge"></span>';
  ...
  function shouldBypassOnboardingGuard() {
    ...
    return ONBOARDING_BYPASS_PATHS.has(path);
  }
