(function () {
  ...
  function updateQuestTasks(profile) {
    ...
    const weeklyTasks = data && data.weeklyTasks && data.weeklyTasks.weekKey === weekKey ? data.weeklyTasks : { weekKey, claims: {} };
    ...
    const weeklyEligible = {
      ...
      'weekly-3-leg-parlay': !!(data && data.weeklyParlayEligible),
