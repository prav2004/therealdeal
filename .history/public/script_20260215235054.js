(function () {
  ...
  const AVATAR_PRESETS = {
    'avatar-1': { skin: '#f8d7c1', hair: '#5a2a18', lip: '#c2410c', hairStyle: 'short' },
    'avatar-2': { skin: '#f2c8a0', hair: '#1f2937', lip: '#b45309', hairStyle: 'fade' },
    'avatar-3': { skin: '#f4d6b0', hair: '#0f172a', lip: '#c2410c', hairStyle: 'spike' },
    'avatar-4': { skin: '#efc9a2', hair: '#334155', lip: '#c2410c', hairStyle: 'cap' },
    'avatar-5': { skin: '#f5d3c8', hair: '#7f1d1d', lip: '#be185d', hairStyle: 'long' },
    'avatar-6': { skin: '#f2d1b3', hair: '#312e81', lip: '#be185d', hairStyle: 'bob' }
  };
  ...
  function ensureAvatarStyles() {
    ...
    style.textContent = `
      .pickr-avatar{--size:40px;--skin:#f8d7c1;--hair:#1f2937;--lip:#c2410c;width:var(--size);height:var(--size);border-radius:999px;background:var(--skin);position:relative;overflow:hidden;border:1px solid rgba(255,255,255,0.18);box-shadow:0 8px 16px rgba(0,0,0,0.25);} 
  ...
  function renderAvatar(el, avatarId) {
    ...
    el.innerHTML = '<span class="hair"></span><span class="eye left"></span><span class="eye right"></span><span class="mouth"></span>';
  }
