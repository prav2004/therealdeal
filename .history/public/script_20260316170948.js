(function () {
  ...
  function createPickCard(pick) {
    ...
    const league = document.createElement('div'); league.className = 'text-xs'; league.style.cssText = 'color:#64748b;font-weight:500;'; league.textContent = pick.league || pick.sport || '';
