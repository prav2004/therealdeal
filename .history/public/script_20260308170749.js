(function () {
  ...
  function ensureAvatarStyles() {
    ...
    style.textContent = `
      .pickr-avatar{--size:40px;--skin:#f8d7c1;--hair:#1f2937;--lip:#c2410c;--jersey:#0ea5e9;--accent:#0f172a;width:var(--size);height:var(--size);min-width:var(--size);min-height:var(--size);aspect-ratio:1/1;display:inline-flex;flex:0 0 var(--size);align-items:center;justify-content:center;border-radius:999px;background:var(--skin);position:relative;overflow:hidden;box-sizing:border-box;border:1px solid rgba(255,255,255,0.18);box-shadow:0 8px 16px rgba(0,0,0,0.25);transform:translateZ(0);} 
