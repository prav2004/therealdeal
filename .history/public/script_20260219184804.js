(function () {
  ...
  function ensureAvatarStyles() {
    ...
    style.textContent = `
      ...
      .pickr-avatar.avatar-compact.hair-spike .hair{height:44%;-webkit-clip-path:polygon(0 100%,14% 46%,28% 100%,42% 44%,50% 100%,58% 46%,72% 100%,86% 44%,100% 100%);clip-path:polygon(0 100%,14% 46%,28% 100%,42% 44%,50% 100%,58% 46%,72% 100%,86% 44%,100% 100%);} 
