...
async function fetchApiSportsGamesByDate(dateKey, season) {
  ...
  setSportsDataCache(cacheKey, list, SPORTSDATA_CACHE_TTL.scores);
  return list;
}
...
async function fetchApiSportsOddsByGame(gameId, season, homeName, awayName) {
  ...
  setSportsDataCache(cacheKey, payload, SPORTSDATA_CACHE_TTL.odds);
  return payload;
}
