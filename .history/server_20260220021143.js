...
function findApiSportsGameByPick(selection, games) {
  ...
  if (!pick) return null;
  const targetTime = selection.commenceTime || selection.startTime || selection.commence_time || selection.start_time || null;
  ...
  matches.forEach((game) => {
    const startRaw = game && game.date ? game.date : (game && game.date && game.date.start ? game.date.start : null);
